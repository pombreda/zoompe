    ...
    partial class PEFile
    {
        ...
        public sealed class Writer
        {
            ...
            public void Write(PEFile pe, Stream stream)
            {
                ...
                WriteDosHeader(pe.DosHeader, writer);
                WritePEHeader(pe.PEHeader, writer);
                WriteOptionalHeader(pe.OptionalHeader, writer);
            ...
            static void WriteDosHeader(DosHeader dosHeader, BinaryStreamWriter writer)
            {
                ...
                if (dosHeader.Stub != null)
                    writer.WriteBytes(dosHeader.Stub, 0, dosHeader.Stub.Length);
            }
            ...
            static void WriteSectionHeader(BinaryStreamWriter writer, Section section)
            {
