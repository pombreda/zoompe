...
namespace Mi.PE.Cli.Tables
{
    ...
    /// additonal methods with other names are also permitted (ECMA §18).
    /// All of the methods gathered together as an <see cref="TableKind.Event"/> shall be defined on the class (ECMA §I.8.11.4)
    ...
    public sealed class EventEntry
    {
        ...
        /// more precisely, a <see cref="TableKind.TypeDefOrRef"/> (ECMA §24.2.6) coded index.
