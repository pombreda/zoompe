...
namespace Mi.PE.Unmanaged
{
    public partial struct RelocationType
    {
        ...
        public static implicit operator RelocationType(SuperH value) { return new RelocationType((short)value); }
        ...
        public static implicit operator RelocationType(Mips value) { return new RelocationType((short)value); }
        public static implicit operator RelocationType(M32R value) { return new RelocationType((short)value); }
        ...
        public static implicit operator SuperH(RelocationType value) { return (SuperH)value.value; }
        ...
        public static implicit operator Mips(RelocationType value) { return (Mips)value.value; }
        public static implicit operator M32R(RelocationType value) { return (M32R)value.value; }
    }
}